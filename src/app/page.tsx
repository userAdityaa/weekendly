        ...
        <div className="relative bottom-15 max-md:bottom-0 max-md:w-[125vw]">
          ...
          <div className="absolute inset-0 top-[16.5rem] left-24 w-[28vw] max-[1182]:w-[29vw] max-[1025]:top-[13rem] max-[1025]:left-20 max-md:w-[90vw] max-md:top-[24vh] max-md:p-4 max-[1181]:top-[15rem] max-[1181]:left-22 max-[391]:left-20">
            <div className="flex flex-col justify-center text-black">
              ...
              <p className="text-2xl max-[1182]:text-[1.4rem] max-[1025]:text-[1.15rem] font-medium w-[85%] text-left mt-[1rem] max-[431]:text-2xl max-[391]:text-[1.4rem]">
              ...
              <button
                ...
                className="relative w-[25vw] rounded-xl border-2 border-black h-[80px] mt-[1rem] bg-[#82ed82ce] max-md:h-[65px] max-md:w-[80vw] max-md:mt-[0.5rem] max-[391]:w-[80vw] max-[391]:-ml-[0.5rem]"
              >
